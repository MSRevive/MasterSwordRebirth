...
constexpr int FTENT_CLIENTCUSTOM = 0x00080000; // Must specify callback.  Callback function is responsible for killing tempent and updating fields ( unless other flags specify how to do things )
constexpr int FTENT_SKIPENT = 0x00100000;  // AUG2013_25 Thothie - Skip collision checks for stored ent index
