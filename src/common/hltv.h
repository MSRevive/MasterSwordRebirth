...
constexpr int DRC_CMD_CAMERA = 4;     // sets camera registers
...
constexpr int DRC_CMD_STATUS = 8;     // status info about broadcast
constexpr int DRC_CMD_BANNER = 9;     // banner file name for HLTV gui
constexpr int DRC_CMD_FADE = 10;      // send screen fade command
constexpr int DRC_CMD_SHAKE = 11;     // send screen shake command
constexpr int DRC_CMD_STUFFTEXT = 12; // like the normal svc_stufftext but as director command
