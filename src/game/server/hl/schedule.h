...
enum {
	bits_COND_NO_AMMO_LOADED = (1 << 0),// weapon needs to be reloaded!
	...
	bits_COND_ENEMY_OCCLUDED = (1 << 5),// target entity occluded by the world
	...
	bits_COND_HEAR_SOUND = (1 << 17),// there is an interesting sound
	bits_COND_SMELL = (1 << 18),// there is an interesting scent
	bits_COND_ENEMY_FACING_ME = (1 << 19),// enemy is facing me
	bits_COND_ENEMY_DEAD = (1 << 20),// enemy was killed. If you get this in combat, try to find another enemy. If you get it in alert, victory dance.
	bits_COND_SEE_CLIENT = (1 << 21),// see a client
	bits_COND_SEE_NEMESIS = (1 << 22),// see my nemesis
	bits_COND_SPECIAL1 = (1 << 28),// Defined by individual monster
